        ...
        return new Promise((resolve,reject)=>{
             ...
             .updateOne({_id:objectId(abduId)},{
                 $set:{
                    ...
                    //RunningMan
                    RunningMan:abduDetails.RunningMan,
        ...
        return new Promise((resolve,reject)=>{
             ...
             .updateOne({_id:objectId(kavuId)},{
                $set:{
                    ...
                    //RunningMan
                    RunningMan:kavuDetails.RunningMan,
        ...
        return new Promise((resolve,reject)=>{
             ...
             .updateOne({_id:objectId(vibinId)},{
                $set:{
                    ...
                    //RunningMan
                    RunningMan:vibinDetails.RunningMan,
        ...
        return new Promise((resolve,reject)=>{
             ...
             .updateOne({_id:objectId(sudheeshId)},{
                $set:{
                    ...
                    //RunningMan
                    RunningMan:sudeeshDetails.RunningMan,
                    ...
                    Remarks:sudeeshDetails.Remarks,
                 }
             }).then((response)=>{
                 resolve()
             })
